...
<div class="w-5/12 flex flex-col bg-blue-gray-50 h-full bg-white pr-4 pl-2 py-4">
    <div class="bg-white rounded-3xl flex flex-col h-full shadow">
        ...
        <div class="select-none h-auto w-full text-center pt-3 pb-4 px-4">
                    ...
                    <div class="flex text-lg font-semibold">
                        ...
                        <div class="flex text-right">
                            <input type="number"
                                pattern="[0-9]+([\.,][0-9]+)?"
                                step="0.01"
                                x-model="cash[currency]"
                                class="w-28 text-right mr-2 bg-white shadow rounded-lg focus:bg-white focus:shadow-lg px-2 focus:outline-none">
                            <div class="mr-2" x-text="currency"></div>
                        </div>
                    </div>
                </div>
            </template>
            ...
            <div class="mb-3 text-blue-gray-700 px-3 pt-2 pb-3 rounded-lg bg-blue-gray-50">
                <div class="flex text-lg font-semibold">
                    <div class="flex-grow text-left">Tarjeta</div>
                    <div class="flex text-right">
                        <input type="number" x-model="cardPayment" x-on:keyup="cardPayment($event.target.value)"
                            type="text"
                            class="w-28 text-right mr-2 bg-white shadow rounded-lg focus:bg-white focus:shadow-lg px-2 focus:outline-none">
                         <div class="mr-2">MXN</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div x-show="change < 0"
            ...
            <div class="text-right flex-grow text-pink-600">
                Faltan <span x-text="priceFormat(change, true)"></span>
            </div>
        </div>
